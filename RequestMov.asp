...
if CountTableValues >= 0 then
	...
	Countries = aTableValues(10, 0)
	Address2 = aTableValues(11, 0)
end if
%>
<HTML>
...
<SCRIPT LANGUAGE="JavaScript">
	function validar(Action) {
  		if (Action != 3) {
			...
			if (!valTxt(document.forma.AccountNo, 3, 5)){return (false)};
		}
...
<BODY text=#000000 vLink=#000000 aLink=#000000 link=#000000 bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
	...
	<INPUT name="CT" type=hidden value="<%=CreatedTime%>">
		...
		<TR><TD class=label align=right><b>Dirección:</TD><TD class=label align=left><INPUT TYPE=text class=label name="Address" value="<%=Address%>" maxlength="60"></TD></TR>
		<TR><TD class=label align=right><b>Dirección 2:</TD><TD class=label align=left><INPUT TYPE=text class=label name="Address2" value="<%=Address2%>" maxlength="60"></TD></TR>
		...
		<TR><TD class=label align=right><b>Attn:</TD><TD class=label align=left><INPUT TYPE=text class=label name="Attn" value="<%=Attn%>" maxlength="45"></TD></TR>
		<TR>
