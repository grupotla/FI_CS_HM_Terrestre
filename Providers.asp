...
if CountTableValues >= 0 then
	...
	CodProv = aTableValues(11, 0)
	Email = aTableValues(12, 0)	
end if
...
<SCRIPT LANGUAGE="JavaScript">
	function validar(Action) {
  		if (Action != 3) {
			...
			if (!valTxt(document.forma.CodProv, 3, 5)){return (false)};
...
<BODY text=#000000 vLink=#000000 aLink=#000000 link=#000000 bgColor=#ffffff leftMargin=0 topMargin=0 marginheight="0" marginwidth="0">
	...
	<INPUT name="CT" type=hidden value="<%=CreatedTime%>">
		...
		<TR><TD class=label align=right><b>Nombre:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="Name" id="Nombre" value="<%=Name%>" maxlength="255" size="50"></TD></TR> 
		<TR><TD class=label align=right><b>Código&nbsp;Proveedor:</b></TD><TD class=label align=left><INPUT TYPE=text class=label name="CodProv" id="Código Proveedor" value="<%=CodProv%>" maxlength="45"></TD></TR> 
		...
		<TR><TD class=label align=right><b>Telefono:</TD><TD class=label align=left><INPUT TYPE=text class=label name="Phone1" id="Teléfono" value="<%=Phone1%>" maxlength="45"></TD></TR>
		...
		<TR><TD class=label align=right><b>Atención:</TD><TD class=label align=left><INPUT TYPE=text class=label name="Attn" id="a quien se puede dirigir (Attn)" value="<%=Attn%>" maxlength="45"></TD></TR>
